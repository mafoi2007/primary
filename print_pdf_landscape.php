<?php 
	...
	if(isset($_SESSION['print'])){
		...
		elseif($_SESSION['print']=='statistiqueTrimestrielle'){
			$pdf->addPage();
			$pdf->Entete();
			$information = $_SESSION['info'];
			$section = $information['section'];
			$titre['fr'] = 'Statistiques Trimestrielles du Trimestre '.$information['trimestre'];
			$titre['en'] = 'Quarterly statistic of Term '.$information['trimestre'];
			$classeTitle['fr'] = 'Classe';
			$classeTitle['en'] = 'Class';
			$enseignantTitle['fr'] = 'Enseignant';
			$enseignantTitle['en'] = 'Teacher';
			...
			$fileName='Statistiques_'.$section.'_trimestre_'.$information['trimestre'].'.pdf';
			$pdf->Output($fileName, 'I');
		}
