			...
			<p>
				Je Suis : 
					<select name='userType' id='userType' onChange='typeUtilisateur()'>
						<option value='null'>-Type Utilisateur-</option>
						<option value='enseignant'>Le Maître</option>
						<option value='cellule'>La Cellule Informatique</option>
						<option value='administrateur'>L'Administrateur</option>
					</select>
			</p>
